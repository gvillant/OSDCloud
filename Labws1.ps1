...
Write-Host "3: Win10 20H2 | English | Enterprise (Windows Update ESD file) + WS1 DS Online 3.3 + WinRE" -ForegroundColor Yellow
Write-Host "4: Win10 20H2 | French | Enterprise (Windows Update ESD file) + WS1 DS Online 3.3 + WinRE" -ForegroundColor Yellow
Write-Host "5: Win11 | English | Enterprise (Windows Update ESD file)" -ForegroundColor Yellow
Write-Host "6: Win11 | English | Enterprise (Windows Update ESD file) + WS1 DS Online 3.3 + WinRE" -ForegroundColor Yellow
Write-Host "8: Start the graphical OSDCloud (Start-OSDCloudGUI)" -ForegroundColor Yellow
